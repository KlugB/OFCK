...
====== Aikido in Kommunikation

. _Eintreten, die Harmonie herstellen_: Höre deinem Gegenüber bewusst zu. Versuche dabei nicht nur den Inhalt zu erfassen, sondern auch den emotionalen Unterstrom und die Bedürfnisse dahinter. Akzeptiere. Wertschätze. Finde die gemeinsame Basis, sei sie auch noch so klein. Baue auf dieser Basis auf.
. ?
...
* Aikido ist nur _ein_ Name für ein Prinzip, das sich in vielen anderen Lehren manifestiert hat. Beispiele:
** _Gewaltfreie Kommunikation_ (Marshall Rosenberg)
** _The Work_ (Byron Katie)
** _Alexander-Technik_ (F. M. Alexander)
** _Ahimsa_ (Hinduismus, Mahatma Gandhi)
** _Achtsamkeit, Mitgefühl_ (Buddhismus)
** _Nächstenliebe_ (Christentum)
** _Tango Argentino_
====
